    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
      ...
      <div className="w-full max-w-md border panel-bracket max-h-[90vh] overflow-y-auto"
        ...
        <div className="p-5 space-y-4">
          {/* Market */}
          <div className="p-3 border" style={{ backgroundColor: '#000000', borderColor: 'rgba(255,255,255,0.08)', borderRadius: 12 }}>
          ...
          <div className="p-4 border panel-bracket"
            style={{ backgroundColor: '#000000', borderColor: 'rgba(124,58,237,0.2)', borderRadius: 12 }}>
        ...
        <div className="flex gap-2 px-5 pb-5">
          ...
          {confirmed ? (
            ...
            <button
              ...
              className="flex-1 py-3 text-sm font-bold transition-all flex items-center justify-center gap-2"
              style={{ backgroundColor: isSubmitting ? '#1a1a1a' : '#7c3aed', color: isSubmitting ? '#555' : '#000', borderRadius: 12 }}
            >
              {isSubmitting ? (
                <>
